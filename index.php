...
<html>
    ...
    <body>
        ...
        Click here to see the selected appointments
            <a href="panier.php">
            <img id="cart" alt="cart" src="css/Medicine.png" >
            </a>
        </div>    
        ...
        <div id="card">
            <div id="list">
                ...
                $connUrl = "mysql://hhmcxfo6xje74yta:dq4uvi52fdjxjcmo@if0ck476y7axojpg.cbetxkdyhwsb.us-east-1.rds.amazonaws.com:3306/n9ivgaye1azpifgp";
